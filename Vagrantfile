...
Vagrant.configure("2") do |config|
  ...
  config.vm.provision "shell", path: "scripts/script_Enable_ssh_password.sh"
  config.vm.provision "shell", privileged: false, path: "scripts/script_Fix_history.sh"
